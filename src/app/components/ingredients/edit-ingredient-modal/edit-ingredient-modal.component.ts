          ...
          <form [formGroup]="ingredientForm" (ngSubmit)="onSubmit()">
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="submit-btn" [disabled]="isLoading">
                ...
                {{ isLoading ? 'Saving...' : 'Update Ingredient' }}
              </button>
            </div>
          </form>
        </div>
...
export class EditIngredientModalComponent implements OnInit, OnChanges {
  ...
  updateForm(): void {
    if (this.ingredient) {
      this.ingredientForm.patchValue({
        ...
        cp: this.ingredient.cp,
        tdn: this.ingredient.tdn,
        cf: this.ingredient.cf,
        me: this.ingredient.me
      });
    }
  }
  ...
  onSubmit(): void {
    ...
    this.ingredientService.update(this.ingredientForm.value).subscribe(
      ...
      (error) => {
        ...
        this.errorMessage = 'Failed to update ingredient. Please try again.';
        this.isLoading = false;
      }
    );
  }
